...
public class Main {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        Connection connection = DriverManager.getConnection("jdbc:h2:file:~/15308/IdeaProjects/crawler/news", USER_NAME, PASSWORD);
...
//            }
            ...
            if (isInterestingLink(link)) {
                ...
                storeIntoDatabaseIfItIsNewsPags(connection, doc, link);
...
//            }
    ...
    private static void storeIntoDatabaseIfItIsNewsPags(Connection connection, Document doc, String link) throws SQLException {
